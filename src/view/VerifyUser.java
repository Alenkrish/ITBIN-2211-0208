...
public class VerifyUser extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email){
        ...
        dtm.setRowCount(0);
        ArrayList<User> list = Usercontroller.getAllRecords(email);
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 140, 350, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Mobile Number", "Adress", "Security Question", "Status"
            }
        ));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(578, 704, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/halloween-party(3).jpg"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (status.equals("true"))
            ...
            status = "true";
        int a = JOptionPane.showConfirmDialog(null, "Do you want to chatnge Status of "+email+"","Select",JOptionPane.YES_NO_OPTION);
        if (a==0)
        {
            Usercontroller.changeStatus(email, status);
            setVisible(false);
